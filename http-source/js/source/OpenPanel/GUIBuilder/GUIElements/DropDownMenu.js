...
OpenPanel.GUIBuilder.GUIElements.DropDownMenu.prototype = {
	...
	build: function() {
		...
		//objTable.border = 1;
		objTable.addClassName("dropdownTable");
		...
		for (var key in this.itemData) {
			...
			if (isfirst) {
				objTR.appendChild(this.constructImageTD(16, h, "menu_1st_left.png"));
			} else {
				objTR.appendChild(this.constructImageTD(16, h ,"menu_mid_left.png"));
			}
			...
			if (isfirst) {
				objTR.appendChild(this.constructImageTD(16, h, "menu_1st_right.png"));
			} else {
				objTR.appendChild(this.constructImageTD(16, h, "menu_mid_right.png"));
			}
